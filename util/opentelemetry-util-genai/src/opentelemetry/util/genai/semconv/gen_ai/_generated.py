...
class EmbeddingsClientOperation:
    ...
    def start(
        ...
        *,
        ...
        self._start_attributes = sampling_attributes
    ...
    def _record_client_operation_duration(
        ...
        *,
        ...
        attrs = self._get_metric_attributes()
    ...
    def start(
        ...
        *,
        ...
        if self.conversation_id is None:
            self.conversation_id = get_ambient_conversation_id(context)
...
class RetrievalClientOperation:
    ...
    def __init__(
        ...
        *,
        ...
        provider_name: Attr.GenAIProviderName | str | None = None,
        request_model: str | None = None,
        retrieval_documents: Sequence[RetrievalDocument] | None = None,
        ...
        self.retrieval_documents: Sequence[RetrievalDocument] | None = (
            retrieval_documents
        )
